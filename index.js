...
const ownerNumbers = ['94703725271','94771853633'] // Add your owner numbers here
...
if (!fs.existsSync(__dirname + '/auth_info_baileys/creds.json')) {
    ...
    filer.download((err, data) => {
        ...
        fs.writeFile(__dirname + '/auth_info_baileys/creds.json', data, (err) => {
            ...
            console.log("CRASH-DELTA-MD Session downloaded ✅")
        })
    })
}
    ...
    try {
        ...
        conn.ev.on('connection.update', async (update) => {
            ...
            if(connection === 'close') {
                ...
                try {
                    const connMsg = `🤖 𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝘾𝙍𝘼𝙎𝙃 𝘿𝙀𝙇𝙏𝘼 𝙈𝘿\n👑 𝘾𝙍𝘼𝙎𝙃 𝘿𝙀𝙇𝙏𝘼 𝙈𝘿 - 𝙉𝙄𝙍𝙊 & 𝙎𝙋𝙀𝙓`
        ...
        conn.ev.on('messages.upsert', async (m) => {
            try {
                ...
                switch(command) {
                    ...
                    case 'alive':
                        try {
                            const aliveMsg = `*🤖 CRASH-DELTA-MD BOT ALIVE!*\n\n*Version:* 1.5.0\n*Prefix:* ${prefix}\n*Runtime:* ${runtime(process.uptime())}\n\n*Features:*\n• 24/7 Active\n• Fast Response\n\n*Developer:* 𝗣𝗥𝗢𝗚𝗥𝗔𝗠𝗜𝗡𝗚 𝗡𝗜𝗥𝗢\n*Powered By:* 𝗖𝗥𝗔𝗦𝗛 𝗗𝗘𝗟𝗧𝗔 𝗠𝗗`

                            await conn.sendMessage(from, {
                                text: aliveMsg,
                                contextInfo: {
                                    externalAdReply: {
                                        title: "CRASH-DELTA-MD-MD BOT",
                                        thumbnailUrl: 'https://i.ibb.co/5W0cc0RC/8259.jpg',
                                        mediaType: 1,
...
// Express server
app.get('/', (req, res) => {
    res.send('CRASH-DELTA-MD Server Running! ✅')
})
